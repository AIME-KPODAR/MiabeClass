...
const T = {
  en: {
    ...
    title: "New Enrollment Teacher",
    subtitle: "Complete the form below to register you as a Teacher.",
    sections: {
    ...
    fields: {
      ...
      email: "Teacher email",
      phone: "Teacher phone",
      Domain: "Domain / matier full informations",
    ...
    submit: "Submit Enrollmment",
    submitting: "Submitting...",
    success: {
      title: "Enrollment Submitted",
      message:
        "The report has been received. A confirmation will be sent shortly.",
      new: "Submit Another",
    },
  },
  fr: {
    ...
    subtitle:
      "Remplissez le formulaire ci-dessous vous inscrire entant qu'enseignant(e).",
    sections: {
      teacher: "Informations sur l'enseigant(e)",
    ...
    fields: {
      ...
      email: "Courriel de l'enseignant(e)",
      phone: "Téléphone de l'enseignant(e)",
      teacherName: "Nom complet de l'enseignant(e)",
      relationship: "Situation Matrimoniale",
      schoolEmail: "Courriel de l'école",
    ...
    success: {
      ...
      message:
        "L'inscription' a été reçue. Une confirmation sera envoyée sous peu.",
              ...
              <section className="rounded-2xl border border-brand-secondary/5 bg-white p-6 shadow-sm sm:p-8">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t.fields.schoolName}</FormLabel>
                        <FormControl>
                          <Input placeholder="" {...field} />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t.fields.schoolEmail}</FormLabel>
                        <FormControl>
                          <Input type="email" placeholder="" {...field} />
                        </FormControl>
                        <FormMessage />
